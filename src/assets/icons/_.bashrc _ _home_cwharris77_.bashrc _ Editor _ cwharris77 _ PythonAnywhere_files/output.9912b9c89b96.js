        ...
        ((s.cancelHelperRemoval = !1),
          e.each(s.sortables, function () {
            ...
            e.isOver
              ...
              : ((e.cancelHelperRemoval = !0), e._trigger("deactivate", t, a));
          }));
      },
      drag: function (t, i, s) {
        e.each(s.sortables, function () {
          ...
          ((n.positionAbs = s.positionAbs),
              ...
              e.each(s.sortables, function () {
                return (
                  ...
                  this !== n &&
                    ...
                    e.contains(n.element[0], this.element[0]) &&
                    (a = !1),
                  a
                );
              })),
            a
              ? (n.isOver ||
                  ...
                  (n.fromOutside = s)),
                n.currentItem && (n._mouseDrag(t), (i.position = n.position)))
              : n.isOver &&
                ((n.isOver = 0),
                (n.cancelHelperRemoval = !0),
                (n.options._revert = n.options.revert),
                (n.options.revert = !1),
                n._trigger("out", t, n._uiHash(n)),
                n._mouseStop(t, !0),
      ...
      drag: function (t, i, s) {
        ...
        (r !== o && "HTML" !== r.tagName
          ? ((a.axis && "x" === a.axis) ||
              ...
              a.scrollSensitivity
                ? (r.scrollTop = n = r.scrollTop + a.scrollSpeed)
                : t.pageY - s.overflowOffset.top < a.scrollSensitivity &&
                  (r.scrollTop = n = r.scrollTop - a.scrollSpeed)),
            (a.axis && "y" === a.axis) ||
              (s.overflowOffset.left + r.offsetWidth - t.pageX <
              a.scrollSensitivity
                ? (r.scrollLeft = n = r.scrollLeft + a.scrollSpeed)
                : t.pageX - s.overflowOffset.left < a.scrollSensitivity &&
                  (r.scrollLeft = n = r.scrollLeft - a.scrollSpeed)))
          : ((a.axis && "x" === a.axis) ||
              (t.pageY - e(o).scrollTop() < a.scrollSensitivity
                ? (n = e(o).scrollTop(e(o).scrollTop() - a.scrollSpeed))
                : e(window).height() - (t.pageY - e(o).scrollTop()) <
                    a.scrollSensitivity &&
                  (n = e(o).scrollTop(e(o).scrollTop() + a.scrollSpeed))),
            (a.axis && "y" === a.axis) ||
              (t.pageX - e(o).scrollLeft() < a.scrollSensitivity
                ? (n = e(o).scrollLeft(e(o).scrollLeft() - a.scrollSpeed))
        ...
        switch (s) {
          ...
          case "intersect":
            return (
              ...
              d > o - t.helperProportions.width / 2 &&
              r + t.helperProportions.height / 2 > u &&
              c > h - t.helperProportions.height / 2
            );
          case "pointer":
            return (
              e(a.pageY, u, i.proportions().height) &&
              e(a.pageX, l, i.proportions().width)
            );
          case "touch":
            return (
              ((r >= u && c >= r) || (h >= u && c >= h) || (u > r && h > c)) &&
              ((n >= l && d >= n) || (o >= l && d >= o) || (l > n && o > d))
            );
          default:
            return !1;
        }
    ...
    e.ui.plugin.add("resizable", "containment", {
      ...
      resize: function (t) {
        ...
        (c[0] !== document && /static/.test(c.css("position")) && (d = h),
          ...
          (i = Math.abs(
            r.sizeDiff.width +
              (r._helper ? r.offset.left - d.left : r.offset.left - h.left),
          )),
          (s = Math.abs(
            r.sizeDiff.height +
              (r._helper ? r.offset.top - d.top : r.offset.top - h.top),
          )),
      ...
      resize: function (t, i) {
        ...
        e(a.alsoResize).each(function () {
          var t = e(this),
            ...
            a = {},
            n = t.parents(i.originalElement[0]).length
              ? ["width", "height"]
            ...
            : /^(ne)$/.test(o)
              ...
              : /^(sw)$/.test(o)
                ...
                : ((0 >= f - u || 0 >= p - l) &&
                  ...
                  f - u > 0
                    ? ((i.size.height = f), (i.position.top = r.top - c))
                    : ((f = u - t.height),
                      (i.size.height = f),
                      (i.position.top = r.top + n.height - f)),
                  p - l > 0
                    ? ((i.size.width = p), (i.position.left = r.left - d))
                    : ((p = l - t.width),
                      (i.size.width = p),
                      (i.position.left = r.left + n.width - p))));
      },
    }),
    e.ui.resizable,
              ...
              return (
                "tbody" === s
                  ? t._createTrPlaceholder(
                      ...
                      e("<tr>", t.document[0]).appendTo(a),
                    )
                  : "tr" === s
                    ? t._createTrPlaceholder(t.currentItem, a)
          ...
          t.length
            ? e.length
              ? ((s = e.show().outerHeight()),
                ...
                void 0)
              : t.animate(this.hideProps, n, a, c)
            : e.animate(this.showProps, n, a, c)
        );
      },
        ...
        for (w = "", this.maxRows = 4, T = 0; V[1] > T; T++) {
          ...
          for (
            M += N + "</tr></thead><tbody>",
              ...
              P = Math.ceil((I + A) / 7),
              H = G ? (this.maxRows > P ? this.maxRows : P) : P,
              this.maxRows = H,
              F = this._daylightSavingAdjust(new Date(et, Z, 1 - I)),
              z = 0;
            H > z;
            z++
          ) {
            for (
              ...
              ((j = g ? g.apply(e.input ? e.input[0] : null, [F]) : [!0, ""]),
                (O = F.getMonth() !== Z),
                (L = (O && !y) || !j[0] || (X && X > F) || ($ && F > $)),
                (E +=
                  "<td class='" +
                  ...
                  ((F.getTime() === D.getTime() &&
                    Z === e.selectedMonth &&
                    e._keyEvent) ||
                  (b.getTime() === F.getTime() && b.getTime() === D.getTime())
                    ? " " + this._dayOverClass
                    : "") +
                  (L
        ...
        if (s) {
          ...
          (i.is("[title]") &&
            ...
            this.options.track && t && /^mouse/.test(t.type)
              ...
              : r.position(e.extend({ of: i }, this.options.position)),
            r.hide(),
      ...
      close: function (t) {
        ...
        return n
          ? ((i = n.tooltip),
            ...
            void 0)
          : (a.removeData("ui-tooltip-open"), void 0);
      },
      _tooltip: function (t) {
        var i = e("<div>")
            .attr("role", "tooltip")
      ...
      function i(t, i) {
        ...
        for (s in i)
          ((n = i[s]),
            t[s] !== n &&
              (a[s] ||
                ((e.fx.step[s] || !isNaN(parseFloat(n))) && (r[s] = n))));
        return r;
      }
 ...
 *//*!
 * Generated using the Bootstrap Customizer (https://getbootstrap.com/docs/3.3/customize/?id=4a2cfb78a6ce95d9991303197c7224b1)
 * Config saved to config.json and https://gist.github.com/4a2cfb78a6ce95d9991303197c7224b1
        ...
        if (
          ...
          if (
            ...
            if ((!a && 27 != i.which) || (a && 27 == i.which))
              return (
                27 == i.which && n.find(s).trigger("focus"),
                o.trigger("click")
              );
...
(function ($) {
  var DoAjaxWithSpinnerAndErrorsAndButtonDisabling = function (params) {
    ...
    for (i = 0; i < params.buttonsToDisable.length; i++) {
      button = params.buttonsToDisable[i];
    ...
    var onSuccess = function (response) {
      ...
      $(params.spinner).hide();
      if (params.hasOwnProperty("onSuccessFunction")) {
    ...
    var onError = function (jqXHR, textStatus, errorThrown) {
      ...
      $(params.spinner).hide();
      if (params.hasOwnProperty("onErrorFunction")) {
        params.onErrorFunction(jqXHR, textStatus, errorThrown);
      } else {
        $(params.error).show();
      }
    };
    ...
    $.ajax({
      headers: { "X-CSRFToken": Anywhere.csrfToken },
      url: params.url,
      data: params.data,
      type: method,
      success: onSuccess,
  ...
  $.extend(true, window, {
    Anywhere: {
      Utils: {
        DoAjaxWithSpinnerAndErrorsAndButtonDisabling:
          DoAjaxWithSpinnerAndErrorsAndButtonDisabling,
      },
    },
  });
...
(function ($) {
  var setButtonVisibility = function () {
    if (Anywhere.TaskHelper.current_step === 0) {
      $("#id_task_helper_back").hide();
    } else {
      $("#id_task_helper_back").show();
    }
    if (
      Anywhere.TaskHelper.current_step ===
      Anywhere.TaskHelper.CURRENT_TASK_STEPS.length - 1
    ) {
      $("#id_task_helper_next").hide();
    } else {
      $("#id_task_helper_next").show();
    }
  };
  var postWithCsrfToken = function (url) {
    $.ajax({
      url: url,
      type: "POST",
      headers: { "X-CSRFToken": Anywhere.csrfToken },
  ...
  var handleClose = function () {
    postWithCsrfToken(Anywhere.TaskHelper.urls.task_helper_close);
    $("#id_task_helper").hide();
    $(window).resize();
  };
  var initialize = function (urls) {
    Anywhere.TaskHelper.urls = urls;
    $("#id_task_helper_text").html(
      Anywhere.TaskHelper.CURRENT_TASK_STEPS[Anywhere.TaskHelper.current_step],
    );
    $("#id_task_helper_next").bind("click", function () {
      Anywhere.TaskHelper.current_step += 1;
      $("#id_task_helper_text").html(
        Anywhere.TaskHelper.CURRENT_TASK_STEPS[
          Anywhere.TaskHelper.current_step
        ],
      );
      postWithCsrfToken(urls.task_helper_next);
      $(window).resize();
      setButtonVisibility();
    });
    $("#id_task_helper_back").bind("click", function () {
      Anywhere.TaskHelper.current_step -= 1;
      $("#id_task_helper_text").html(
        Anywhere.TaskHelper.CURRENT_TASK_STEPS[
          Anywhere.TaskHelper.current_step
      ...
      postWithCsrfToken(urls.task_helper_back);
      $(window).resize();
      setButtonVisibility();
    });
    $("#id_task_helper_close").bind("click", Anywhere.TaskHelper.handleClose);
    $("#id_task_helper_close_inline").bind(
      "click",
      Anywhere.TaskHelper.handleClose,
    );
    setButtonVisibility();
  };
  $.extend(true, window, {
    Anywhere: {
      TaskHelper: { handleClose: handleClose, initialize: initialize },
    },
  });
})(jQuery);
(function ($) {
  function Initialise(urls, showEmail) {
    ...
    $(".feedback_link").click(function (event) {
      Anywhere.FeedbackDialog.showFeedbackDialog();
    ...
    $("#id_feedback_dialog_ok_button").click(function () {
      ...
      $("#id_feedback_dialog_error").hide();
      $("#id_feedback_dialog_rate_limit_error").hide();
      Anywhere.Utils.DoAjaxWithSpinnerAndErrorsAndButtonDisabling({
        ...
        buttonsToDisable: [
          ...
          "#id_feedback_dialog_cancel_button",
        ],
        onSuccessFunction: showSuccess,
        onErrorFunction: showError,
      });
    });
    $("#id_feedback_dialog_cancel_button").click(_closeDialog);
    $("#id_feedback_dialog_close_button").click(_closeDialog);
    window.addEventListener("message", showFeedbackDialog, false);
  }
  function showError(jqXHR, textStatus, errorThrown) {
    if (jqXHR.status === 429) {
      $("#id_feedback_dialog_rate_limit_error").show();
    } else {
      $("#id_feedback_dialog_error").show();
    }
    $("#id_feedback_dialog_success").hide();
  }
  function showSuccess() {
    $(".dialog_buttons").hide();
    $("#id_feedback_dialog_error").hide();
    $("#id_feedback_dialog_rate_limit_error").hide();
    $("#id_feedback_dialog_only_close_button").show();
    $("#id_feedback_dialog_success").show();
    $("#id_feedback_dialog_text").attr("disabled", "disabled");
    $("#id_feedback_dialog_email_address").attr("disabled", "disabled");
  }
  function showFeedbackDialog(e) {
    if (e !== undefined && e.data !== "showdialog") {
      return;
    }
    $("#id_feedback_dialog_error").hide();
    $("#id_feedback_dialog_rate_limit_error").hide();
    $("#id_feedback_dialog_spinner").hide();
    $("#id_feedback_dialog_success").hide();
    $("#id_feedback_dialog_only_close_button").hide();
    $("#id_feedback_dialog_ok_button").removeAttr("disabled");
    $("#id_feedback_dialog_cancel_button").removeAttr("disabled");
    $("#id_feedback_dialog_text").removeAttr("disabled");
    $("#id_feedback_dialog_text").val("");
    $("#id_feedback_dialog_email_address").removeAttr("disabled");
    $(".dialog_buttons").show();
    $("#id_feedback_dialog").dialog({ width: 610, close: _closeDialog });
  }
...
$(function () {
  ...
  $.extend(Anywhere.urls, { feedback: "/feedback/submit/" });
  Anywhere.FeedbackDialog.Initialise(Anywhere.urls, false);
});
